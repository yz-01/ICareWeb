...
class ForgotPasswordController extends Controller
{
    ...
    */
    ...
    {
        return view('center_user.auth.passwords.email');
    }
    ...
    public function forgot(Request $request)
    {
        ...
        $user = CenterUser::where('email', $request->email)->first();
        ...
        $response = Password::broker('center_users')->sendResetLink(['email'=>$user->email]);
        // dd($response);
        // dd(123);
    ...
    {
        return Password::broker('center_users');
    }
}
