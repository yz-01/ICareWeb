...
class TreatmentController extends Controller
{
    ...
    public function edit(Treatment $treatment)
    {
        ...
        return view('doctor.treatments.edit', compact('check_treatment', 'treatment', 'patient', 'doctor', 'nurse', 'ward', 'medicine', 'support_doctor', 'support_nurse', 'number_support_doctor', 'number_support_nurse'));
    }
    ...
    public function historyEdit(Request $request)
    {
        ...
        return view('doctor.treatments.historyEdit', compact('history_medicine', 'treatment', 'treatment_medicine', 'medicine', 'history'));
    }
    ...
    public function historyShow(Request $request)
    {
        ...
        return view('doctor.treatments.historyShow', compact('history_medicine', 'treatment', 'treatment_medicine', 'medicine', 'history'));
    }
