...
use App\DataTables\Nurse\AnnouncementDataTable;
...
class AnnouncementController extends Controller
{
    ...
    {
        return $dataTable->render('nurse.announcements.index');
    }
    ...
    public function create()
    {
        ...
        return view('nurse.announcements.create', compact('branch'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('nurse.announcements.index');
    }

    public function show(Announcement $announcement)
    {
        return view('nurse.announcements.show', compact('announcement'));
    }
    ...
    public function edit(Announcement $announcement)
    {
        ...
        return view('nurse.announcements.edit', compact('announcement', 'branch'));
    }
    ...
    public function destroy(Announcement $announcement)
    {
        ...
        return redirect()->route('nurse.announcements.index')->with('success', 'Announcement Deleted Successfully');
    }
