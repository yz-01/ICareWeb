...
class TreatmentController extends Controller
{
    ...
    public function show(Treatment $treatment)
    {
        ...
        return view('patient.treatments.show', compact('treatment', 'patient', 'doctor', 'nurse', 'ward', 'medicine', 'support_doctor', 'support_nurse', 'number_support_doctor', 'number_support_nurse'));
    }
