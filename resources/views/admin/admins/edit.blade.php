...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-sm-0 font-size-18">Admin Edit - {{ $admin->name }}</h4>
...
<div class="row">
    <div class="col-lg-6">
        <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Admin Information</h4>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="tel" class="form-control @error('identity_card') is-invalid @enderror" name="identity_card" placeholder="Identity Card" value="{{ old('identity_card') ?: $admin->identity_card }}">
                        @error('identity_card')
                        <div class="invalid-feedback">
                            <span>{{ $message }}</span>
                        </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="Phone" value="{{ old('phone') ?: $admin->phone }}">
                        @error('phone')
                        <div class="invalid-feedback">
                            <span>{{ $message }}</span>
                        </div>
