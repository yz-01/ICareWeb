<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('admin.branches.show',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-branch-{{$item->id}}" method="POST" action="{{ route('admin.branches.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
