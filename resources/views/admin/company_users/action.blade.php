<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('admin.company_users.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('admin.company_users.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-company-user-{{$item->id}}" method="POST" action="{{ route('admin.company_users.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
