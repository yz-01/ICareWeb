...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-sm-0 font-size-18">Company Password Change - {{ $company_user->name }}</h4>
                <ol class="breadcrumb m-0 mt-3">
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.company_users.index') }}">Company List</a>
                    </li>
                    <li class="breadcrumb-item active">Company Password Change</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('admin.company_users.updatePassword', $company_user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Company Account Password Change</h4>
                            <div class="card mb-2">
