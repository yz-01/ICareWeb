                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="claimable" class="form-control @error('claimable') is-invalid @enderror">
                            <option value="1" {{ old('claimable') == 1 ? 'selected' : ''}}>Yes</option>
                            <option value="2" {{ old('claimable') == 2 ? 'selected' : ''}}>No</option>
                        </select>
                        @error('claimable')
                            <div class="invalid-feedback">
                                <span>{{ $message }}</span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="datetime-local" class="form-control @error('datetime') is-invalid @enderror" name="datetime" placeholder="Date Time" value="{{ old('datetime') ?: '' }}">
                        @error('datetime')
                            <div class="invalid-feedback">
                                <span>{{ $message }}</span>
                            </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control @error('duration') is-invalid @enderror" name="duration" placeholder="Duration" value="{{ old('duration') ?: '' }}">
                        @error('duration')
                            <div class="invalid-feedback">
                                <span>{{ $message }}</span>
                            </div>
                            ...
                            <div class="col-10">
                                <select name="trainer" class="form-control @error('trainer') is-invalid @enderror">
                                    ...
                                    @forelse($trainers as $trainer)
                                        <option value="{{$trainer->id}}" {{ old('trainer') == $trainer->id ? 'selected' : ''}}>{{$trainer->name}}</option>
                                    @empty
