    ...
    <div class="col-12 col-md-3">
        <div class="card mini-stats-wid">
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        <p class="text-muted fw-medium">Total Nurses</p>
                        <h4 class="mb-0">
                            <span>{{ $total_nurse }}</span>
                        </h4>
                    </div>
    ...
    <div class="col-12 col-md-3">
        <div class="card mini-stats-wid">
            <div class="card-body">
                <div class="d-flex">
                    <div class="flex-grow-1">
                        <p class="text-muted fw-medium">Total Treatments</p>
                        <h4 class="mb-0">
                            <span>{{ $total_treatment }}</span>
                        </h4>
                    </div>
                    ...
                    <div class="flex-shrink-0 align-self-center">
                        <div class="mini-stat-icon avatar-sm rounded-circle bg-primary">
                            <span class="avatar-title">
                                <i class="fas fa-stethoscope font-size-24"></i>
                            </span>
                        </div>
                    </div>
                </div>
