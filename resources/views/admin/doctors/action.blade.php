<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('admin.doctors.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('admin.doctors.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-doctor-{{$item->id}}" method="POST" action="{{ route('admin.doctors.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
