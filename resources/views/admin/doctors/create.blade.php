            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="area_of_experise" class="form-control @error('area_of_experise') is-invalid @enderror" name="area_of_experise" placeholder="Area of Expertise" value="{{ old('area_of_experise') ?: '' }}" required>
