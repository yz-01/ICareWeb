...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-sm-0 font-size-18">Doctor Edit - {{ $doctor->name }}</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="file-upload" style="border-radius:65px;">
                            ...
                            @else
                                <img id="imageResult1" src="{{ asset($doctor->image) }}" class="w-100 h-100" style="object-fit:contain;">
                            @endif
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('branch_id') is-invalid @enderror" name="branch_id" required>
                            ...
                            <option value="{{ $branches->id }}" {{ $doctor->branch_id == $branches->id ? 'selected' : '' }}>{{ $branches->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name" value="{{ old('name') ?: $doctor->name }}" required>
                        @error('name')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="tel" class="form-control @error('identity_card') is-invalid @enderror" name="identity_card" placeholder="Identity Card" value="{{ old('identity_card') ?: $doctor->identity_card }}">
                        @error('identity_card')
                        <div class="invalid-feedback">
                            <span>{{ $message }}</span>
                        </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" placeholder="Phone" value="{{ old('phone') ?: $doctor->phone }}">
                        @error('phone')
                        <div class="invalid-feedback">
                            <span>{{ $message }}</span>
                        </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email" value="{{ old('email') ?: $doctor->email }}" required>
                        @error('email')
                        <div class="invalid-feedback">
                            <span>{{ $message }}</span>
                        </div>
                    ...
                    <div class="form-group mb-3">
                        <label for="area_of_experise">Area of Expertise<span class="text-danger">*</span></label>
                        <input type="area_of_experise" class="form-control @error('area_of_experise') is-invalid @enderror" name="area_of_experise" placeholder="Area of Expertise" value="{{ old('area_of_experise') ?: $doctor->area_of_experise }}" required>
        ...
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('admin.doctors.updatePassword', $doctor->id) }}" method="POST">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Doctor Account Password Change</h4>
                            <div class="card mb-2">
