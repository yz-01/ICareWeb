    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <a href="{{ route('admin.doctors.create') }}" class="btn btn-primary waves-effect waves-light">Create</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                <div class="d-none d-md-flex mb-3">
                    ...
                    <div class="px-2 flex-fill">
                        <select class="form-select select-status datatable-input" id="doctor_status">
