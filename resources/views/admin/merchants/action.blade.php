<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('admin.merchants.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('admin.merchants.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-merchant-{{$item->id}}" method="POST" action="{{ route('admin.merchants.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
