    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <div>
                    <h4 class="mb-sm-0 font-size-18">Merchant</h4>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-body">
                    <div class="d-none d-md-flex mb-3">
                        ...
                        <div class="pe-2 flex-fill">
                            <input type="text" class="form-control datatable-input" id="company_name" placeholder="Company Name" data-col-index="2">
                        </div>
                        <div class="pe-2 flex-fill">
                            <input type="text" class="form-control datatable-input" id="name" placeholder="PIC Name" data-col-index="2">
                        </div>
                        <div class="pe-2 flex-fill">
                        ...
                        <div class="px-2 flex-fill">
                            <select class="form-select select-status datatable-input" id="merchant_status">
