<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('admin.nurses.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('admin.nurses.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-nurse-{{$item->id}}" method="POST" action="{{ route('admin.nurses.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
