<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('admin.patients.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('admin.patients.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-patient-{{$item->id}}" method="POST" action="{{ route('admin.patients.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
