    ...
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <a href="{{ route('admin.rooms.create') }}" class="btn btn-primary waves-effect waves-light">Create</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="d-none d-md-flex mb-3">
                    <div class="pe-2 flex-fill">
                        <input type="number" class="form-control datatable-input" id="floor" placeholder="Floor" data-col-index="2">
                    </div>
                    ...
                    <div class="px-2 flex-fill">
                        <select class="form-select datatable-input" id="room_type_id">
                    ...
                    <div class="px-2 flex-fill">
                        <select class="form-select select-status datatable-input" id="room_status">
