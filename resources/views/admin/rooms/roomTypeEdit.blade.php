...
<form action="{{ route('admin.rooms.roomTypeUpdate') }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="number" class="form-control @error('max_number') is-invalid @enderror" name="id" placeholder="Maximum Number" value="{{ $room_type->id }}" hidden>
                            <div class="form-group mb-3">
                                <label for="name">Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name" value="{{ $room_type->name }}">
                            </div>
                            <div class="form-group mb-3">
                                <label for="max_number">Maximum Number<span class="text-danger">*</span></label>
                                <input type="number" class="form-control @error('max_number') is-invalid @enderror" name="max_number" placeholder="Maximum Number" value="{{ $room_type->max_number }}">
                            </div>
                        </div>
