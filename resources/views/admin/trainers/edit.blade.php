...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-sm-0 font-size-18">Trainer Password Change - {{ $trainer->name }}</h4>
                <ol class="breadcrumb m-0 mt-3">
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.trainers.index') }}">Trainer List</a>
                    </li>
                    <li class="breadcrumb-item active">Trainer Password Change</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="row">
            <div class="col-lg-12">
                <form action="{{ route('admin.trainers.updatePassword', $trainer->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Trainer Account Password Change</h4>
                            <div class="card mb-2">
