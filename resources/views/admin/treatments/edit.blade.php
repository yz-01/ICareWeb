                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('medicine_id') is-invalid @enderror" name="last_time_medicine_id[]" id="medicine_id">
                        ...
                        <div class="col-lg-3">
                            <div class="mb-3">
                                ...
                                @foreach($treatment->treatment_medicine as $treatment_medicines)
                                <input type="number" class="form-control" name="last_time_number[]" value="{{ $treatment_medicines->usage_of_medicine }}">
                                <br>
                                @endforeach
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @if($treatment->support_doctor)
                        <div class="col-lg-10">
                            <div class="mb-3">
                                <label class="form-label">Support Doctor<span class="text-danger">*</span></label>
                                @foreach($treatment->support_doctor as $support_doctors)
                                <select class="form-select @error('pic_doctor_id') is-invalid @enderror" name="pic_doctor_id" id="pic_doctor_id">
                                    <option value="">-- Please Select --</option>
                                    @foreach($doctor as $doctors)
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        @if($treatment->support_nurse)
                        <div class="col-lg-10">
                            <div class="mb-3">
                                <label class="form-label">Support Nurse<span class="text-danger">*</span></label>
                                @foreach($treatment->support_nurse as $support_nurses)
                                <select class="form-select @error('pic_doctor_id') is-invalid @enderror" name="pic_doctor_id" id="pic_doctor_id">
                                    <option value="">-- Please Select --</option>
                                    @foreach($nurse as $nurses)
