<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('admin.wards.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('admin.wards.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-ward-{{$item->id}}" method="POST" action="{{ route('admin.wards.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
