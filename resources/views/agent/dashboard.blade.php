                                    ...
                                    <div class="rbt-default-sidebar-wrapper">
                                        ...
                                        <nav class="mainmenu-nav">
                                            <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                                                <li><a href="{{ route('agent.dashboard','#dashboard') }}"><i class="feather-home"></i><span>Dashboard</span></a></li>
                                                {{-- <li><a href="{{ route('agent.profile.index') }}"><i class="feather-user"></i><span>My Profile</span></a></li> --}}
                                                ...
                                                {{-- <li><a href="{{ route('agent.profile.edit', auth()->user()->id) }}"><i class="feather-settings"></i><span>Settings</span></a></li> --}}
                                                <li><a class="" href="{{ route('agent.logout') }}"
                                        ...
                                        {{-- <div class="section-title mt--40 mb--20">
                                            <h6 class="rbt-title-style-2">agent</h6>
                                        </div>
