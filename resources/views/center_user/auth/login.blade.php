            ...
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    ...
                    <ul class="page-list">
                        ...
                        <li class="rbt-breadcrumb-item active">Center Login</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-5 row--30 d-flex justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                    ...
                    <form class="max-width-auto" action="{{ route('center_user.login') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12 d-flex">
                                ...
                                <div class="ms-auto">
                                    @if (Route::has('center_user.password.request'))
                                        <a class="btn" href="{{ route('center_user.password.request') }}" style="font-size: 15px; color: var(--body-color)">
                    ...
                    <div class="row pt-3">
                        <div class="col-lg-12 text-center">
                            <a href="{{ route('center_user.register.create') }}" class="text-primary"><u>Haven't Register? Register Now</u></a>
                        </div>
                    </div>
                </div>
            </div>
