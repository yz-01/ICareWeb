            ...
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    ...
                    <ul class="page-list">
                        ...
                        <li class="rbt-breadcrumb-item"><a href="{{ route('center_user.login') }}">Center Login</a></li>
                        <li>
                            <div class="icon-right"><i class="feather-chevron-right"></i></div>
                        </li>
                        <li class="rbt-breadcrumb-item active">Center Forgot Password</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-5 row--30 d-flex justify-content-center">
            ...
            <div class="col-lg-6">
                ...
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                    ...
                    <form class="max-width-auto" action="{{ route('center_user.password.email') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <label>Email *</label>
