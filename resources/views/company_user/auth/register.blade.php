@extends('company_user.auth.layouts.app')
        ...
        <div class="row pt-4">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    <h3 class="">Company Register</h3>
                    <ul class="page-list">
                        <li class="rbt-breadcrumb-item"><a href="/">Home</a></li>
                        <li>
                            <div class="icon-right"><i class="feather-chevron-right"></i></div>
                        </li>
                        <li class="rbt-breadcrumb-item active">Company Register</li>
                    </ul>
                    <label class="description" for="">Register your company today and earn HRDP reward points! Our courses are perfect for upskilling your employees, and with our company registration, you can purchase courses or HRDF claimable courses for your team. Your company will earn HRDP reward points for every purchase, which can be redeemed for exclusive offers and discounts. Don't miss out on the benefits of company registration - register today!</label>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row gy-5 row--30 d-flex justify-content-center">
            ...
            <div class="col-lg-12">
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                    ...
                    <form class="max-width-auto" action="{{ route('company_user.register.create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row pt-4">
                            <div class="col-lg-6">
