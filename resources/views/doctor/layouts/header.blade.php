        ...
        <div class="d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                               <a href="{{ route('doctor.notifications') }}" class="small"> View All</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('doctor.doctors.show', auth()->user()->id) }}"><i class="bx bx-user font-size-16 align-middle me-1"></i> <span key="t-profile">Profile</span></a>
                    ...
                    <form id="logout-form" action="{{ route('doctor.logout') }}" method="post" class="d-none">@csrf</form>
                </div>
            </div>
        </div>
    </div>
