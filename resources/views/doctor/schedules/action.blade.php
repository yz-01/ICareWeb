<div>
    <div class="row">
        <!-- <div class="col-3">
            <a href="{{route('doctor.schedules.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('doctor.schedules.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-schedule-{{$item->id}}" method="POST" action="{{ route('doctor.schedules.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
