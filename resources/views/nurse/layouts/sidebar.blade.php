    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('nurse.dashboard') }}" class="waves-effect">
                        <i class="bx bx-home-circle"></i>
                        <span>Dashboards</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('nurse.treatments.index') }}" class="waves-effect">
                        <i class="bx bx-plus-medical"></i>
                        <span>Treament</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('nurse.schedules.index') }}" class="waves-effect">
