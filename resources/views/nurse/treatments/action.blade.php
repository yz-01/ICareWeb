<div>
    <div class="row">
        <div class="col-3">
            <a href="{{route('nurse.treatments.show',$item->id)}}">
        ...
        <div class="col-3">
            <a href="{{route('nurse.treatments.history',['treatment_id' => $item->id])}}">
        ...
        <div class="col-3">
            <a href="{{route('nurse.treatments.edit',$item->id)}}">
        ...
        <div class="col-3">
            ...
            <form id="delete-treatment-{{$item->id}}" method="POST" action="{{ route('nurse.treatments.destroy', $item->id) }}" class="destroy_{{$item->id}} d-none">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
            </form>
        </div>
