@extends('patient.auth.layouts.app')
@push('style')
<style>
    .password-eye:hover {
            ...
            <div class="col-lg-6">
                <div class="my-2" style="border-radius: 5px; background-color: rgb(255, 255, 255)">
                    <ul class="nav nav-pills nav-justified" role="tablist">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link" href="{{ route('doctor.login') }}" role="tab">
                ...
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                    <div class="text-center">
                        ...
                        <h6 class="pt-4">Patient Login</h6>
                    </div>
                    <form class="max-width-auto" action="{{ route('patient.login') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12 d-flex">
                                ...
                                <div class="ms-auto">
                                    ...
                                    <a class="btn" href="{{ route('patient.password.request') }}" style="font-size: 15px; color: var(--body-color)">
