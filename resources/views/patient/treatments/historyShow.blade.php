        ...
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <div>
                ...
                <ol class="breadcrumb m-0 mt-3">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('patient.treatments.history', ['treatment_id' => $treatment])}}">Treatment History List</a></li>
...
<form action="{{route('patient.treatments.historyUpdate')}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('POST')
    <div class="row">
        <div class="col-xl-3">
