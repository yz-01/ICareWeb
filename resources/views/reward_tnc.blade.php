        ...
        <div class="breadcrumb-image-container breadcrumb-style-max-width">
            ...
            <div class="breadcrumb-content-top text-center">
                ...
                <ul class="page-list">
                    ...
                    <li class="rbt-breadcrumb-item active">Rewards & Benefits Terms </li>
                </ul>
            </div>
        </div>
        ...
        <div class="rbt-putchase-guide-area breadcrumb-style-max-width rbt-section-gapBottom">
            <div class="rbt-article-content-wrapper">
                <div class="content">
                    ...
                    <p>
                        These Point Rewards Terms and Conditions (these “Terms and Conditions”) are provided to all HRDP account holders (“<b>You</b>" or “<b>Your</b>") by Point Up Inc. (“<b>Point</b>," “<b>our</b>” or “<b>we</b>”) solely for the purpose of promoting and offering the Point reward program (“<b>Program</b>") redemption offers to qualified Point Card holders who have been approved to participate in the Program and to obtain a Point Card rewards account (“<b>Rewards</b>"). These Terms and Conditions are a separate agreement and are not part of the Terms and Conditions of Your Point Account (the “Agreement”).
                    </p>
                    <h5>
                    ...
                    <p>
                        You will earn and accrue points based on registration, referral and purchase activity and usage of Your Point Account (as defined in the Agreement), according to the active point earnings scale which can be found on the HRDP website and APP. In addition to the standard point earnings scale, You may earn points as may be authorized by Point from time-to-time for special programs, promotions or transactions that may be offered for limited time periods and for which additional terms and conditions may apply.
                    </p>
                    <p>
                    ...
                    <p>
                        No points will be retroactively applied to Your Rewards for otherwise qualifying transactions occurring during any period in which Your Point Account was not in Good Standing or when you were not enrolled into this Program.  You will automatically begin earning points upon opening Your Point Account and enrolling in the Point Rewards Program, subject to Points approval of such enrollment request. You may notify Point that You want to withdraw from the Program at any time.
                    </p>
                    <p>
                    ...
                    <p>
                        Points are not Your property and may not be assigned or transferred to any person (including upon death or as a part of a domestic relations matter). Points have neither cash value, surrender value, transfer value nor any other value of any kind until and to the extent they are actually redeemed by Point. Points cannot be used to offset any amount due from You to Point on the Point Account. Points used by You for redemption will be those unredeemed points that have been Rewards the longest time. Points earned by You may only be redeemed for a Redemption (a "Redemption Reward" or "Reward"). All redemptions are final. The sale or barter of any points, other than by Point, is expressly prohibited.
                    </p>
