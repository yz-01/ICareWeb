...
{{--                        12 sublist--}}
                        <li>
                            ...
                            <ol>
                                ...
                                <p style="text-align: justify;">If you believe that a Member, Offering or Content poses an imminent risk of harm to a person or property, you should immediately contact local authorities before contacting HRDP. In addition, if you believe that a Member, Offering or Content has violated our Standards, you should report your concerns to HRDP. If you reported an issue to local authorities, HRDP may request a copy of that report. Except as required by law, you agree that we are not obligated to take action in response to any report.</p>

                                <li>
                                    <b>Copyright Notifications.</b>
                                </li>
                                <p style="text-align: justify;">If you believe that Content on the HRDP Platform infringes copyrights, please notify us in accordance with our Copyright Policy.</p>
                            </ol>
{{--                                end of 12 sublist--}}
                            <br>
{{--                                13 sub list--}}
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            <br><br>
                                            <p style="text-align: justify;">If you breach these Terms, applicable laws, regulations, or third-party rights, or HRDP believes it is reasonably necessary to protect HRDP, its Members, or third parties; HRDP may, with or without prior notice:</p>
