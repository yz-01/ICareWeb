@extends('trainer.auth.layouts.app')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    <h3 class="">Trainer Login</h3>
                    <ul class="page-list">
                        <li class="rbt-breadcrumb-item"><a href="/">Home</a></li>
                        <li>
                            <div class="icon-right"><i class="feather-chevron-right"></i></div>
                        </li>
                        <li class="rbt-breadcrumb-item active">Trainer Login</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-5 row--30 d-flex justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                    <h5 class="">Trainer Login Information</h5>
                    <form class="max-width-auto" action="{{ route('trainer.login') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12 d-flex">
                                ...
                                <div class="ms-auto">
                                    @if (Route::has('trainer.password.request'))
                                        <a class="btn" href="{{ route('trainer.password.request') }}" style="font-size: 15px; color: var(--body-color)">
                    ...
                    <div class="row pt-3">
                        <div class="col-lg-12 text-center">
                            <a href="{{ route('trainer.register.create') }}" class="text-primary"><u>Haven't Register? Register Now</u></a>
                        </div>
                    </div>
                </div>
            </div>
