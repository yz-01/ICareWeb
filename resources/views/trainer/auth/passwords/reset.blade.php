        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    <h3 class="">Trainer Reset Password</h3>
                    <ul class="page-list">
                        <li class="rbt-breadcrumb-item"><a href="/">Home</a></li>
                        <li>
                            <div class="icon-right"><i class="feather-chevron-right"></i></div>
                        </li>
                        <li class="rbt-breadcrumb-item active">Trainer Reset Password</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row gy-5 row--30 d-flex justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                    <h5 class="">Trainer Reset Password</h5>
                    <div class="card">
                    ...
                    <form class="max-width-auto" action="{{ route('trainer.password.reset') }}" method="POST" enctype="multipart/form-data">
                        @csrf
