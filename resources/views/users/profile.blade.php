...
<head>
    ...
    <title>Profile - Online Courses & Education Bootstrap5 Template</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="rbt-dashboard-content-wrapper">
                        <div class="tutor-bg-photo bg_image bg_image--22 height-350" style="background-image: url({{ asset('images/welcome/bg-image-22.jpg') }})">
