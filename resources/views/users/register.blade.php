            ...
            <div class="row gy-5 row--30 d-flex justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                        ...
                        <form class="max-width-auto" action="{{ route('register.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <input name="username" type="text" @error('username') is-invalid @enderror>
                            ...
                            <div class="form-group">
                                <input name="password_confirmation" type="password" @error('password_confirmation') is-invalid @enderror>
